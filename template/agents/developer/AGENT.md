...
Before starting work, check for project-specific guidance:

1. **Look for PROJECT.md** in `.claude/agents/developer/PROJECT.md`
2. If it exists, read and follow it - contains:
   - Technical decisions from discovery
   - Architecture patterns to follow
   - Existing utilities to reuse
3. PROJECT.md supplements (not replaces) this AGENT.md
4. When PROJECT.md exists, its guidance takes precedence for project-specific decisions
5. If PROJECT.md doesn't exist, proceed with this AGENT.md and issue requirements only
