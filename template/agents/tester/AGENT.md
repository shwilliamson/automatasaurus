...
Before testing, check for project-specific test guidance:

1. **Look for PROJECT.md** in `.claude/agents/tester/PROJECT.md`
2. If it exists, read it - contains:
   - Acceptance criteria summary
   - Critical user journeys
   - Edge cases and error states
   - E2E test coverage requirements
3. Use this to prioritize verification efforts
4. If PROJECT.md doesn't exist, proceed with this AGENT.md and issue acceptance criteria only
