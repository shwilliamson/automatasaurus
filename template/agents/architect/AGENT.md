...
Before conducting reviews, check for project-specific context:

1. **Look for PROJECT.md** in `.claude/agents/architect/PROJECT.md`
2. If it exists, read it - contains:
   - Architecture summary and constraints
   - Non-functional requirements
   - Technical risks and ADR considerations
3. Use this context to inform reviews
